cask "focusrite-volume-control" do
  ...
  url "https://github.com/enum-solutions-inc/FocusriteVolumeControl/releases/download/v#{version}/FocusriteVolumeControl.dmg"
  name "Focusrite Volume Control"
  desc "Control Focusrite Scarlett 4th gen volume with media keys via Focusrite Control 2"
  homepage "https://enum-solutions-inc.github.io/FocusriteVolumeControl/"
